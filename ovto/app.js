...
Opal.modules["ovto/actions"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_writer', '$state', '$_app']);
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_actions_1, TMP_Actions_state_2;

      def.wired_actions = nil;
      
      self.$attr_writer("wired_actions");
      
      Opal.defn(self, '$actions', TMP_Actions_actions_1 = function $$actions() {
        var self = this;

        return self.wired_actions
      }, TMP_Actions_actions_1.$$arity = 0);
      return (Opal.defn(self, '$state', TMP_Actions_state_2 = function $$state() {
        var self = this;

        return self.wired_actions.$_app().$state()
      }, TMP_Actions_state_2.$$arity = 0), nil) && 'state';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["ovto/app"] = function(Opal) {
  ...
  Opal.add_stubs(['$run', '$new', '$const_get', '$class', '$attr_reader', '$log_error', '$_run', '$private', '$wired_actions=', '$-', '$create_view', '$start_application', '$raise', '$+', '$setup']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_App_run_1, TMP_App_initialize_2, TMP_App_actions_3, TMP_App__set_state_4, TMP_App_run_6, TMP_App_setup_7, TMP_App__run_8, TMP_App_create_view_9, TMP_App_start_application_10;
      ...
      Opal.defn(self, '$create_view', TMP_App_create_view_9 = function $$create_view() {
        var self = this, main_component_class = nil, orig_ex = nil;
        ...
        try {
          ...
          if (Opal.rescue($err, [Opal.const_get_relative($nesting, 'NameError')])) {orig_ex = $err;
            try {
              ...
              var $no_errors = true;try {
                ...
                if ($no_errors) { 
                  self.$raise($rb_plus("Since Ovto 0.3.0, View is renamed to MainComponent. Please rename ", "" + (self.$class()) + "::View to " + (self.$class()) + "::MainComponent"))
                }};
            } finally { Opal.pop_exception() }
          } else { throw $err; }
        }finally {
        ...
        return main_component_class.$new(self.wired_actions);
      }, TMP_App_create_view_9.$$arity = 0);
      return (Opal.defn(self, '$start_application', TMP_App_start_application_10 = function $$start_application(runtime, view, container) {
        var self = this;

        
        runtime.$run(view, container);
        return self.$setup();
      }, TMP_App_start_application_10.$$arity = 3), nil) && 'start_application';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["ovto/component"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$each', '$state', '$_app', '$private', '$do_render', '$debug_trace_log', '$[]', '$parameters', '$method', '$nil?', '$accepts_state?', '$render', '$reject', '$==', '$empty?', '$native?', '$is_a?', '$raise', '$render_children', '$===', '$render_component', '$extract_attrs', '$!', '$render_tag', '$merge_attrs', '$+', '$inspect', '$class', '$push', '$last', '$[]=', '$-', '$merge', '$to_s', '$call', '$pop', '$>', '$length', '$new', '$hash_to_js_obj']);
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Component_hash_to_js_obj_2, TMP_Component_initialize_3, TMP_Component_render_4, TMP_Component_state_5, TMP_Component_render_view_6, TMP_Component_do_render_8, TMP_Component_accepts_state$q_10, TMP_Component_actions_11, TMP_Component_o_12, TMP_Component_extract_attrs_14, TMP_Component_merge_attrs_15, TMP_Component_render_children_16, TMP_Component_render_component_18, TMP_Component_render_tag_19;
...
if (k == null) k = nil;if (v == null) v = nil;
      ...
      Opal.defn(self, '$state', TMP_Component_state_5 = function $$state() {
        var self = this;

        return self.wired_actions.$_app().$state()
      }, TMP_Component_state_5.$$arity = 0);
      self.$private();
      
      Opal.defn(self, '$render_view', TMP_Component_render_view_6 = function $$render_view(state) {
        var self = this;

        return self.$do_render($hash2(["state"], {"state": state}))
      }, TMP_Component_render_view_6.$$arity = 1);
      
      Opal.defn(self, '$do_render', TMP_Component_do_render_8 = function $$do_render($kwargs) {
        var $a, $b, TMP_7, self = this, args, parameters = nil, args_wo_state = nil;
        ...
        Opal.const_get_relative($nesting, 'Ovto').$debug_trace_log("" + "rendering " + (self));
        self.vdom_tree = [];
        ...
        if ($truthy(($truthy($a = ($truthy($b = !parameters) ? $b : parameters['$nil?']())) ? $a : self['$accepts_state?'](parameters)))) {
          ...
          args_wo_state = $send(args, 'reject', [], (TMP_7 = function(k, v){var self = TMP_7.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return k['$==']("state")}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7));
      ...
      }, TMP_Component_do_render_8.$$arity = -1);
      
      Opal.defn(self, '$accepts_state?', TMP_Component_accepts_state$q_10 = function(parameters) {try {

        var TMP_9, self = this;

        
        $send(parameters, 'each', [], (TMP_9 = function(item){var self = TMP_9.$$s || this, $a, $b;
if (item == null) item = nil;
      ...
      }, TMP_Component_accepts_state$q_10.$$arity = 1);
      
      Opal.defn(self, '$actions', TMP_Component_actions_11 = function $$actions() {
        var self = this;

        return self.wired_actions
      }, TMP_Component_actions_11.$$arity = 0);
      
      Opal.defn(self, '$o', TMP_Component_o_12 = function $$o(_tag_name, arg1, arg2) {
        var $a, TMP_13, self = this, $iter = TMP_Component_o_12.$$p, block = $iter || nil, attributes = nil, content = nil, children = nil, $case = nil, result = nil, tag_name = nil, base_attributes = nil, more_attributes = nil;
        ...
        if ($iter) TMP_Component_o_12.$$p = null;
        
        if ($truthy(self['$native?'](arg1))) {
          
          attributes = $hash2([], {});
          content = arg1;
        } else if ($truthy(arg1['$is_a?'](Opal.const_get_relative($nesting, 'Hash')))) {
        ...
        more_attributes = $send(attributes, 'reject', [], (TMP_13 = function(k, v){var self = TMP_13.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return v['$!']()}, TMP_13.$$s = self, TMP_13.$$arity = 2, TMP_13));
      ...
      }, TMP_Component_o_12.$$arity = -2);
      
      Opal.defn(self, '$extract_attrs', TMP_Component_extract_attrs_14 = function $$extract_attrs(tag_name) {
      ...
      }, TMP_Component_extract_attrs_14.$$arity = 1);
      
      Opal.defn(self, '$merge_attrs', TMP_Component_merge_attrs_15 = function $$merge_attrs(base_attributes, attributes) {
      ...
      }, TMP_Component_merge_attrs_15.$$arity = 2);
      
      Opal.defn(self, '$render_children', TMP_Component_render_children_16 = function $$render_children(content, block) {
        ...
        else if ($truthy(content)) {if ($truthy(self['$native?'](content))) {
          return [content]
          } else {
          return [content.$to_s()]
        }}
        ...
        if ($truthy($rb_gt(results.$length(), 0))) {
          return results
        } else if ($truthy(self['$native?'](block_value))) {
          return [block_value]
      ...
      }, TMP_Component_render_children_16.$$arity = -1);
      
      Opal.defn(self, '$render_component', TMP_Component_render_component_18 = function $$render_component(comp_class, args, children) {
        var TMP_17, self = this, comp = nil, render_args = nil;

        
        comp = comp_class.$new(self.wired_actions);
        render_args = $hash2(["state"], {"state": self.current_state}).$merge(args);
        return $send(comp, 'do_render', [Opal.to_hash(render_args)], (TMP_17 = function(){var self = TMP_17.$$s || this;

        return children}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17));
      }, TMP_Component_render_component_18.$$arity = 3);
      return (Opal.defn(self, '$render_tag', TMP_Component_render_tag_19 = function $$render_tag(tag_name, attributes, children) {
      ...
      ;
        return ret;
      }, TMP_Component_render_tag_19.$$arity = 3), nil) && 'render_tag';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
};
...
Opal.modules["ovto/wired_actions"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $send = Opal.send, $hash2 = Opal.hash2, $hash = Opal.hash, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$log_error', '$invoke_action', '$respond_to?', '$private', '$merge', '$state', '$__send__', '$nil?', '$is_a?', '$native?', '$raise', '$inspect', '$!=', '$scheduleRender', '$_set_state']);
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_WiredActions_initialize_1, TMP_WiredActions_method_missing_3, TMP_WiredActions_respond_to$q_4, TMP_WiredActions__app_5, TMP_WiredActions_invoke_action_6;
      ...
      Opal.defn(self, '$method_missing', TMP_WiredActions_method_missing_3 = function $$method_missing(name, args_hash) {
        var TMP_2, self = this;

        if (args_hash == null) {
          args_hash = $hash2([], {});
        }
        return $send(Opal.const_get_relative($nesting, 'Ovto'), 'log_error', [], (TMP_2 = function(){var self = TMP_2.$$s || this;

        return self.$invoke_action(name, args_hash)}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2))
      }, TMP_WiredActions_method_missing_3.$$arity = -2);
      
      Opal.defn(self, '$respond_to?', TMP_WiredActions_respond_to$q_4 = function(name) {
        var self = this;

        return self.actions['$respond_to?'](name)
      }, TMP_WiredActions_respond_to$q_4.$$arity = 1);
      
      Opal.defn(self, '$_app', TMP_WiredActions__app_5 = function $$_app() {
        var self = this;

        return self.app
      }, TMP_WiredActions__app_5.$$arity = 0);
      self.$private();
      return (Opal.defn(self, '$invoke_action', TMP_WiredActions_invoke_action_6 = function $$invoke_action(name, args_hash) {
        var $a, $b, $c, self = this, kwargs = nil, state_diff = nil, new_state = nil;

        
        kwargs = $hash2(["state"], {"state": self.app.$state()}).$merge(args_hash);
        state_diff = self.actions.$__send__(name, Opal.to_hash(kwargs));
        if ($truthy(($truthy($a = ($truthy($b = ($truthy($c = state_diff['$nil?']()) ? $c : state_diff['$is_a?'](Opal.const_get_relative($nesting, 'Promise')))) ? $b : !!state_diff.then)) ? $a : state_diff['$is_a?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'State'))))) {
          return nil};
        if ($truthy(self['$native?'](state_diff))) {
          self.$raise("" + "action `" + (name) + "' returned js object: " + (name.toString()))};
        if ($truthy(state_diff['$is_a?'](Opal.const_get_relative($nesting, 'Hash')))) {
          } else {
          self.$raise("" + "action `" + (name) + "' must return hash but got " + (state_diff.$inspect()))
        };
        ...
        return new_state;
      }, TMP_WiredActions_invoke_action_6.$$arity = 2), nil) && 'invoke_action';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
};
...
Opal.modules["ovto"] = function(Opal) {
  ...
  Opal.add_stubs(['$==', '$require', '$log', '$console', '$+', '$inspect', '$call', '$raise', '$name', '$class', '$Array', '$backtrace']);
  ...
  return (function($base, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Ovto_debug_trace_2, TMP_Ovto_debug_trace$eq_3, TMP_Ovto_debug_trace_log_4, TMP_Ovto_inspect_5, TMP_Ovto_log_error_6;

    
    self.debug_trace = false;
    Opal.defs(self, '$debug_trace', TMP_Ovto_debug_trace_2 = function $$debug_trace() {
      var self = this;
      if (self.debug_trace == null) self.debug_trace = nil;

      return self.debug_trace
    }, TMP_Ovto_debug_trace_2.$$arity = 0);
    Opal.defs(self, '$debug_trace=', TMP_Ovto_debug_trace$eq_3 = function(bool) {
      var self = this;

      return (self.debug_trace = bool)
    }, TMP_Ovto_debug_trace$eq_3.$$arity = 1);
    Opal.defs(self, '$debug_trace_log', TMP_Ovto_debug_trace_log_4 = function $$debug_trace_log(msg) {
      var self = this;
      if (self.debug_trace == null) self.debug_trace = nil;

      if ($truthy(self.debug_trace)) {
        return self.$console().$log($rb_plus("Ovto: ", msg))
        } else {
        return nil
      }
    }, TMP_Ovto_debug_trace_log_4.$$arity = 1);
    Opal.defs(self, '$inspect', TMP_Ovto_inspect_5 = function $$inspect(obj) {
      var self = this;
    ...
    }, TMP_Ovto_inspect_5.$$arity = 1);
    Opal.defs(self, '$log_error', TMP_Ovto_log_error_6 = function $$log_error() {
      var self = this, $iter = TMP_Ovto_log_error_6.$$p, block = $iter || nil, ex = nil, div = nil;

      if ($iter) TMP_Ovto_log_error_6.$$p = null;
      try {
        return block.$call()
      } catch ($err) {
